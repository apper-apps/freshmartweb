...
<div className="mb-4">
                         ...
                         <div className="relative group">
                           ...
                           <button
                             onClick={(e) => {
                               e.stopPropagation();
                               const imageUrl = verification.paymentProof || verification.paymentProofThumbnail || 'data:image/svg+xml;base64,';
                               // Try to open in new tab, fallback to download if possible
                               if (!imageUrl.startsWith('data:image/svg+xml')) {
                                 window.open(imageUrl, '_blank');
                               } else {
                                 // For placeholder images, show a message
                                 alert('Payment proof image is not available for download.');
                               }
                             }}
